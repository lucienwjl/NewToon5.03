	...
	bool bIsTranslucencyWritingVelocity)
{
	...
	case MP_Tangent:
		...
		//7.lucien: 在材质编辑器面板激活CustomToon这个Shadingmodel下的Subsurface pin口
	case MP_SubsurfaceColor:
		Active = ShadingModels.HasAnyShadingModel({ MSM_Subsurface, MSM_PreintegratedSkin, MSM_TwoSidedFoliage, MSM_Cloth, MSM_CustomToon });
		break;
		//7.lucien: 在材质编辑器面板激活CustomToon这个Shadingmodel下的CustomData0 pin口
	case MP_CustomData0:
		Active = ShadingModels.HasAnyShadingModel({ MSM_ClearCoat, MSM_Hair, MSM_Cloth, MSM_Eye, MSM_SubsurfaceProfile, MSM_CustomToon });
		break;
		//7.lucien: 在材质编辑器面板激活CustomToon这个Shadingmodel下的CustomData1 pin口
	case MP_CustomData1:
		Active = ShadingModels.HasAnyShadingModel({ MSM_ClearCoat, MSM_Eye, MSM_CustomToon });
		break;
