...
FText FMaterialAttributeDefinitionMap::GetAttributeOverrideForMaterial(const FGuid& AttributeID, UMaterial* Material)
{
	...
	case MP_Metallic:
		...
		//15.lucien: 对不同shadingmodel下的Metallic口改名字
		CustomPinNames.Add({MSM_CustomToon, "Specular Range"});

		
		return FText::FromString(GetPinNameFromShadingModelField(Material->GetShadingModels(), CustomPinNames, "Metallic"));
	case MP_Specular:

		//15.lucien: 对不同shadingmodel下的Specular口改名字(下面注释掉的是官方代码)
		CustomPinNames.Add({MSM_CustomToon, "Specular Intensity"});
	...
	case MP_Roughness:
		...
		//15.lucien: 对不同shadingmodel下的Roughenss口改名字(下面注释掉的是官方代码)
		CustomPinNames.Add({MSM_CustomToon, "Shadow Threshold"});
	...
	case MP_SubsurfaceColor:
		...
		//15.lucien: 对不同shadingmodel下的Subsurface Color pin口改名字
		CustomPinNames.Add({MSM_CustomToon, "Cartoon Shadow Color Tint" });
	...
	case MP_CustomData0:	
		...
		//8.lucien: 对不同shadingmodel下的CustomData0 pin口改名字
		CustomPinNames.Add({MSM_CustomToon, "ShadowRange" });
	...
	case MP_CustomData1:
		...
		//8.lucien: 对不同shadingmodel下的CustomData1 pin口改名字
		CustomPinNames.Add({MSM_CustomToon, "Custom Data Inpuut 1" });
